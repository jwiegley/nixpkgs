  ...
  binDists = {
    x86_64-linux = let bdist = bdistForArch { inUrl = "linux64"; inTar = "x64"; }; in {
      alpha = {
        ...
        experimental  = bdist { sha256 = "0g4ygrgbhsyfr87g2h370r35gwz8xg5bqb3lkjkjns3vfsq54qri"; version = "0.16.16"; fetcher = authenticatedFetch; };
      };
      headless = {
        stable        = bdist { sha256 = "0v5sypz1q6x6hi6k5cyi06f9ld0cky80l0z64psd3v2ax9hyyh8h"; };
        experimental  = bdist { sha256 = "0ds0sxyk6vg06k925vca5khdc25rgc84vbrzhy3jx98l4gm9vxs3"; version = "0.16.16"; };
      };
      demo = {
