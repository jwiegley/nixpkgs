...
stdenv.mkDerivation rec {
  ...
  patches = [(fetchpatch {
    name = "perl-5.26.patch";
    url = "https://anonscm.debian.org/viewvc/pkg-gnome/desktop/unstable/intltool/debian/patches/perl5.26-regex-fixes.patch?revision=52688&view=co";
